...
function applySystemTint() {
	...
	const tintWeights = {
	    ...
	    '--search-background-dark': { w: 0.15, type: 'bg' },
	    ...
	    '--search-background-light': { w: 0.15, type: 'bg' },
	    ...
	    '--search-background-dark-highcontrast': { w: 0.25, type: 'bg' },
	    ...
	    '--search-background-light-highcontrast': { w: 0.25, type: 'bg' },
